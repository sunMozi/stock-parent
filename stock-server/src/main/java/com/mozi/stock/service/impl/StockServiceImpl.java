...
public class StockServiceImpl implements StockService {
  ...
  public PageResult<MoreVO> more(Integer page, Integer pageSize) {
    ...
    Page<MoreVO> pageRes = PageHelper.startPage(page, pageSize).doSelectPage(() -> stockRtInfoMapper.selectMore(last));

    return PageResult.of(pageRes.getTotal(), page, pageSize, pageRes.getResult());
  }
}